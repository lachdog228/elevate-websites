      ...
      <div className="shell">
        <div
          className={[
            ...
            scrolled ? "h-[4.5rem]" : "h-[5.5rem] sm:h-24",
          ].join(" ")}
        >
          {/* Wordmark */}
          <a
            ...
            aria-label={`${business.legalName} — back to top`}
          >
            <span
              className={[
            ...
            <span
              ...
              className={[
                ...
                scrolled || open ? "bg-clay" : "bg-clay-light",
              ].join(" ")}
            />
          </a>
                  ...
                  <a
                    ...
                    className={[
                      ...
                      scrolled
                        ...
                        : "text-bone/85 hover:text-bone after:bg-clay-light",
                    ].join(" ")}
                  >
                    {link.label}
                  </a>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className={[
                ...
                scrolled || open ? "text-graphite hover:text-clay" : "text-bone/85 hover:text-bone",
              ].join(" ")}
            >
            ...
            <a
              ...
              className={[
                ...
                scrolled || open ? "text-ink hover:text-clay" : "text-bone",
              ].join(" ")}
            >
                ...
                {navLinks.map((link) => (
                  <li key={link.href} className="border-b border-line last:border-b-0">
                    <a
                      ...
                      className="flex min-h-14 items-center font-display text-3xl text-ink"
                    >
                      {link.label}
                    </a>
                  </li>
